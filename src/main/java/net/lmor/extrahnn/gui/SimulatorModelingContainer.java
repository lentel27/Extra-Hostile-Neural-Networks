...
public class SimulatorModelingContainer extends BlockEntityContainer<SimulatorModelingTileEntity> {
    public SimulatorModelingContainer(int id, Inventory pInv, BlockPos pos) {
        super(ExtraHostile.Containers.SIMULATOR_MODELING.get(), id, pInv, pos);
        SimulatorModelingTileEntity.SimulatorModelingItemHandler inventory = this.tile.getInventory();
